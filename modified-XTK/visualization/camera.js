 ...
 * @return {!Array} The up-vector as an array [X,Y,Z].
 */
X.camera.prototype.__defineGetter__('rotatationenable', function() {
...
/**
 * Done by LONI TEAM 2 Mengyi Zhu. SO we have an option to not rotate
 */
X.camera.prototype.__defineSetter__('rotationenable', function(rotatationenable) {

  if (!goog.isDefAndNotNull(rotatationenable) ) {
    
    throw new Error('Invalid value for rotate.');
    
  }
  
  
  this._rotationenabled = rotatationenable;
